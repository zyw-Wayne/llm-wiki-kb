...
在阅读这篇文章前，我也简单地浏览了现有介绍 MCP 的文章。我发现大部分文章停留在"翻译" [https://modelcontextprotocol.io/](https://modelcontextprotocol.io/) 网站中的内容，或者花时间在绝大部分用户不关心的技术细节上（还有一些纯 AI 文）。
...
- 访问 [https://modelcontextprotocol.io/llms-full.txt](https://modelcontextprotocol.io/llms-full.txt) 并复制完整的文档文本。（实测这个太长了，可以忽略）
...
![MCP Inspector测试](images/06-MCP-Inspector测试.jpg)
...
![Claude Desktop MCP配置](images/07-Claude-Desktop-MCP配置.jpg)
...
![MCP权限请求](images/08-MCP权限请求.jpg)

![MCP实际使用效果](images/09-MCP实际使用效果.jpg)
...
[GitHub - keli-wen/mcp_chatbot: A simple chatbot implementation compatible with MCP](https://github.com/keli-wen/mcp_chatbot)

terminal 版本（更全面的 Tool Json 解析和 Workflow Tracer）：

![Chatbot Terminal Demo](images/10-chatbot-terminal-demo.jpg)

streamlit 版本

![MCP Chatbot Streamlit DEMO](images/11-chatbot-streamlit-demo.jpg)
